...
if __name__=='__main__':
    ...
    # model = FCN(classes=2, batch_shape=(1, 512, 512, 4))
    #model = Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(1, 512, 512, 4),
    #                  classes=2, backbone='xception', OS=16, alpha=1.)
